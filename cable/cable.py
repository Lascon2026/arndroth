...
# create the cable
cable = h.Section(name='cable')  # the name here is used for graphics but doesn't produce a hoc pointer
cable.L, cable.diam, cable.nseg = 10000, 1, 1001 # microns, microns, num
cable.insert('pas')  # this is a SECTION level call that puts 'pas' into all of the 1001 SEGMENTs
cable.g_pas, cable.e_pas = 1.0/20000, -65  # 1/(Ohm cm^2) = Siemens/cm^2, mV;  this access will set all of the segments
...
def setpas (sec, gpas=1.0/20000, epas=-65):  # provide defaults
